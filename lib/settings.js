 ...
 * @property {string} backend - Backend type: 'flowfuse' or 'deepseek' (default: 'flowfuse')
 ...
 * @property {string} [baseUrl] - Override for DeepSeek's API base URL (default: 'https://api.deepseek.com')
 * @property {string} [model] - Model ID for AI backends (e.g. 'deepseek-v4-flash')
...
module.exports = {
    ...
    getSettings: async (RED) => {
        ...
        const settings = {
            ...
            baseUrl: assistantSettings.baseUrl || 'https://api.deepseek.com',
