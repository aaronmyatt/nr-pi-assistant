 ...
 * decouples the handlers from any specific backend so we can use the direct
 * DeepSeek transport by default while still keeping the original FlowFuse
 * backend around for compatibility and parity testing.
 *
